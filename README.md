...
기존 기부 플랫폼과 달리, 모금된 자금은 관리자가 즉시 인출할 수 없으며 스마트 컨트랙트에 안전하게 보관됩니다. 자금을 사용하기 위해서는 사용처 증빙(영수증)을 IPFS에 업로드하고, 기부자들의 투표를 통해 과반수의 승인을 받아야만 집행이 가능합니다.
...
### Storage
* **IPFS (via Pinata):** 대용량 증빙 이미지 분산 저장
